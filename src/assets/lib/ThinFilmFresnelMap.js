 ...
 * @author https://github.com/timohausmann/threejs-thin-film-iridescence/blob/master/js/ThinFilmFresnelMap.js
 */
 import * as THREE from 'three'

 export default class ThinFilmFresnelMap extends THREE.DataTexture {
